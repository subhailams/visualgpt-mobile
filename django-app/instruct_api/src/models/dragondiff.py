...
class DragonPipeline:
    def __init__(self, sd_id='stabilityai/stable-diffusion-2-1', ip_id='/home/silama3/visualgpt_react/django-app/instruct_api/src/models/ip_sd15_64.bin', NUM_DDIM_STEPS=50, precision=torch.float32, ip_scale=0):
